...
<body>
	...
	<div id="bigBox">
		...
		<div id="smallBox1">
			...
			<form action = "artysta_zg.php">
				<input type="submit" id="button1" value = "2) Zgłoszenie do konkursu" />
			</form>

			<form action = "artysta_hm.php">
				<input type="submit" id="button2" value = "6) Oceny występów" />
			</form>
		</div>
	...
	<form action = "logout.php">
		<input type="submit" id="button4" value = "Wyloguj użytkownika" />
	</form>

	<form action = "logout.php">
		<input type="submit" id="button3" value = "<?php echo $user_data['imie']; ?> <?php echo $user_data['nazwisko']; ?>" />
	</form>
